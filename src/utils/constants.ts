...
export const SCORE_DESCRIPTIONS = {
  1: {
    ...
    description:
      "Agregados quebram facilmente com os dedos. Tamanho e aparência dos agregados: Maioria < 6 mm após a quebra. Alta porosidade e raízes por todo solo.",
    characteristic: "Agregados pequenos",
  },
  2: {
    title: "Qualidade estrutural (Qe) 2 Intacto",
    description:
      "Agregados quebram facilmente com uma mão. Uma mistura de agregados porosos e redondos entre 2 mm – 7 cm. Maioria dos agregados são porosos e raízes por todo solo.",
    characteristic: "Agregados altamente porosos",
  },
  3: {
    title: "Qualidade estrutural (Qe) 3 Firme",
    description:
      "Maioria dos agregados quebram com uma mão. Uma mistura de agregados porosos entre 2mm -10 cm; menos de 30% são <1 cm. Macroporos e fissuras presentes.",
    characteristic: "Agregados com baixa porosidade",
  },
  4: {
    title: "Qualidade estrutural (Qe) 4 Compacto",
    description:
      "Quebrar agregados com uma mão requer esforço considerável. Maioria > 10 cm e são sub-angulares não porosos. Poucos macroporos e fissuras.",
    characteristic: "Macroporos bem distintos",
  },
  5: {
    title: "Qualidade estrutural (Qe) 5 Muito compacto",
    description:
      "Difícil quebra. Maioria são maiores que > 10 cm, muito poucos < 7 cm, angular e não poroso. Porosidade muito baixa.",
